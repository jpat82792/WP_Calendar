...
<div id="calendar-status-bar">
  <button id="calendar-back-button">back</button><!--<button class="clean-button" id="prev-month-btn">"<"</button>--><label id="calendar-status-bar-label"><?php  echo($current_month_text); ?></label><!--<button class="clean-button" id="next-month-btn">">"</button>-->
</div>
<?php
}
